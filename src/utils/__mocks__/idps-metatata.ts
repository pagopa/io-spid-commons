export default `<?xml version="1.0" encoding="UTF-8" standalone="no"?><md:EntitiesDescriptor xmlns:md="urn:oasis:names:tc:SAML:2.0:metadata" xmlns:ds="http://www.w3.org/2000/09/xmldsig#" xmlns:saml="urn:oasis:names:tc:SAML:2.0:assertion" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" ID="_34aadd11-e3d9-4311-a410-4039de088446" Name="https://idps.spid.gov.it"><ds:Signature>
<ds:SignedInfo>
...
lMDbdL6Ec/0xAljQSOFpozFduGoYTKF6Ig2Z5NleHPuYVyWLmBhw0lGfyvKGyk9Ev55WxTwHapQB
        ...
        <md:IDPSSODescriptor WantAuthnRequestsSigned="true" protocolSupportEnumeration="urn:oasis:names:tc:SAML:2.0:protocol">
            <md:KeyDescriptor use="signing">
                <ds:KeyInfo>
                    <ds:X509Data>
                        <ds:X509Certificate>
                            MIIDHDCCAgSgAwIBAgIVALisbudTRxLy3vlMcEDfaqr3iW89MA0GCSqGSIb3DQEB
                            ...
                            YVNHp+PSFs9SD8l+2PO4Oh8Y3dYT+5ojv+S6T7vy5xE= </ds:X509Certificate>
                    </ds:X509Data>
                </ds:KeyInfo>
            </md:KeyDescriptor>
    ...
    <!-- NAMIRIAL ID *start* -->
    <md:EntityDescriptor xmlns:xsi="http://www.w3.org/2001/XMLSchemainstance" ID="_pfx8cdfef6c-7dff-4e1c-a9eb-2c51cac9d137" entityID="https://idp.namirialtsp.com/idp">
        <md:IDPSSODescriptor WantAuthnRequestsSigned="true" protocolSupportEnumeration="urn:oasis:names:tc:SAML:2.0:protocol">
            <md:KeyDescriptor use="signing">
                <ds:KeyInfo>
                    <ds:X509Data>
                        <ds:X509SubjectName>CN=*.namirialtsp.com,OU=Security Departement,O=Namirial
                            Spa,L=Senigallia,ST=Ancona,C=IT</ds:X509SubjectName>
        ...
        <md:Organization>
            ...
            <md:OrganizationDisplayName xml:lang="it">Namirial S.p.a. Trust Service
    ...
    <md:EntityDescriptor ID="_ff3cffde0ce6f778bc26f1ebcc782548" entityID="https://spid.register.it">
        ...
        <md:Organization>
            ...
            <md:OrganizationDisplayName xml:lang="it">Register.it
                S.p.A.</md:OrganizationDisplayName>
    ...
    <!-- TIM ID *start* -->
    <md:EntityDescriptor ID="_d2301c246999a2b66348086deeaa3befc1bde2341" entityID="https://login.id.tim.it/affwebservices/public/saml2sso">
        <md:IDPSSODescriptor WantAuthnRequestsSigned="true" protocolSupportEnumeration="urn:oasis:names:tc:SAML:2.0:protocol">
            <md:KeyDescriptor use="signing">
                <ds:KeyInfo>
                    <ds:X509Data>
                        <ds:X509IssuerSerial>
                            <ds:X509IssuerName>CN=TI Trust Technologies srl,OU=Servizi per
                                l'identita digitale,O=Telecom Italia Trust Technologies
                                srl,L=Pomezia,ST=RM,C=IT</ds:X509IssuerName>
                            <ds:X509SerialNumber>9785832575673139601</ds:X509SerialNumber>
                        </ds:X509IssuerSerial>
                        <ds:X509Certificate></ds:X509Certificate>
                        <ds:X509SubjectName>CN=TI Trust Technologies srl,OU=Servizi per l'identita
                            digitale,O=Telecom Italia Trust Technologies
                            srl,L=Pomezia,ST=RM,C=IT</ds:X509SubjectName>
                    </ds:X509Data>
                </ds:KeyInfo>
            </md:KeyDescriptor>
            <md:KeyDescriptor use="signing">
        ...
        <md:Organization>
            ...
            <md:OrganizationDisplayName xml:lang="en">Trust Technologies
                srl</md:OrganizationDisplayName>
